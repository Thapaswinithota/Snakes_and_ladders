...
import { AiFillGitlab, AiFillHeart, AiFillLinkedin, AiOutlineGithub, AiTwotoneDownCircle, AiTwotonePlusSquare } from "react-icons/ai";
    ...
    return (
        <>
            ...
            <div className={`${start ? "" : "hidden"} absolute float-left md:w-[130px] w-[280px] lg:w-[160px] xl:w-[200px] mx-auto px-auto flex justify-evenly bottom-0  mt-[100%] mb-[10px] mlogo `}>
                <a href='https://github.com/Thapaswinithota?tab=overview&from=2024-10-01&to=2024-10-31' target='_blank'><AiOutlineGithub className={`text-[26px] hover:scale-110 kknkl`} /></a>
                <a href='https://www.linkedin.com/in/venkata-thapaswini-thota-877184203/' target='_blank'><AiFillLinkedin className={`text-[26px] hover:scale-110 kknkl`} /></a>
            </div>
